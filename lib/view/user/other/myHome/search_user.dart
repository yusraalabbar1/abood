...
class searchProductUser extends StatefulWidget {
  searchProductUser({Key? key}) : super(key: key);

  @override
  State<searchProductUser> createState() => _searchProductUserState();
}

class _searchProductUserState extends State<searchProductUser> {
