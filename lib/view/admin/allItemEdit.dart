...
class AllItemsStoreEdit extends StatefulWidget {
  final id;
  const AllItemsStoreEdit({super.key, this.id});

  @override
  State<AllItemsStoreEdit> createState() => _AllItemsStoreEditState();
}

class _AllItemsStoreEditState extends State<AllItemsStoreEdit> {
  int i = 0;
  double account = 2.0;
  int currentPage = 0;
  Text text1(text) {
