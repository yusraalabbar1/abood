...
class AllItemsStoreoffer extends StatefulWidget {
  final id;
  const AllItemsStoreoffer({super.key, this.id});

  @override
  State<AllItemsStoreoffer> createState() => _AllItemsStoreofferState();
}

class _AllItemsStoreofferState extends State<AllItemsStoreoffer> {
  int i = 0;
  double account = 2.0;
  int currentPage = 0;
  Text text1(text) {
                                          ...
                                          Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                                builder: (context) => AddOffer(
                                                      id: passenger.itemId,
                                                      text: passenger.descEn,
                                                      price: passenger.newPrice,
                                                      isoffer:
                                                          passenger.isOffer,
                                                      image: passenger
                                                                  .itemImages!
