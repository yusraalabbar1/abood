...
class AllItemsStoreAddIMg extends StatefulWidget {
  final id;
  const AllItemsStoreAddIMg({super.key, this.id});

  @override
  State<AllItemsStoreAddIMg> createState() => _AllItemsStoreAddIMgState();
}

class _AllItemsStoreAddIMgState extends State<AllItemsStoreAddIMg> {
  int i = 0;
  double account = 2.0;
  int currentPage = 0;
  Text text1(text) {
