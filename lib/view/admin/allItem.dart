...
class AllItemsStore extends StatefulWidget {
  final id;
  const AllItemsStore({super.key, this.id});

  @override
  State<AllItemsStore> createState() => _AllItemsStoreState();
}

class _AllItemsStoreState extends State<AllItemsStore> {
  int i = 0;
  double account = 2.0;
  int currentPage = 0;
  Text text1(text) {
